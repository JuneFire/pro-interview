package com.leetcode.huawei.C55虚拟游戏理财;
/*
题目描述在一款虚拟游戏中生活，你必须进行投资以增强在虚拟游戏中的资产以免被淘汰出局。
        现有一家Bank，它提供有若干理财产品 m 个，风险及投资回报不同，你有 N (元) 进行投资，能接收的总风险值为X
        你要在可接受范围内选择最优的投资方式获得最大回报。
        备注：

        ·在虚拟游戏中，每项投资风险值相加为总风险值； ·在虚拟游戏中，最多只能投资2个理财产品；
        ·在虚拟游戏中，最小单位为整数，不能拆分为小数；
        · 投资额$^{*}$回报率=投资回报

        输入描述第一行：

        ·产品数 (取值范围[1,20]) ·总投资额 (整数，取值范围[1, 10000])
